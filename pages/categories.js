...
function Categories({ swal }) {
    ...
    function deleteCategory(category) {
        swal.fire({
            title: 'Tem certeza?',
            text: `Você vai deletar a categoria "${category.name}"`,
    ...
    function removeProperty(indexToRemove) {
        setProperties(prev => {
            return [...prev].filter((p, pIndex) => { return pIndex !== indexToRemove; });
        })
    }
            ...
            <form onSubmit={saveCategory} className="">
                ...
                <div className="mb-2">
                    ...
                    <button
                        onClick={addProperty}
                        type="button"
                        className="btn-secundary mb-2">Adicionar nova prodiedade
                    </button>
